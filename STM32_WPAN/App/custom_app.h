...
/* Exported macros ------------------------------------------------------------*/
/* USER CODE BEGIN EM */
typedef void (*btDataReceiveCallbackFunction_t) (char*,int);
/* USER CODE END EM */
...
/* USER CODE BEGIN EF */
void livedataUpdateChar(char *btString);
void angleUpdateChar(char *btString);
void bt_updateConfigString(char *btString);
